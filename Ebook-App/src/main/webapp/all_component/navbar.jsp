...
<body style="margin: 0px;">
    <header class="headr-css">
        <div class="search-main-menu">
            <form id="blog-post-search" class="search-form" action="search.jsp" method="get">
            ...
            <div class="mm-nav">
                ...
                <div class="search-nav">
                    <div class="search-navigation_wrap">
                        <a href="javascript:;" class="search-open" title="Tìm kiếm"> 
        ...
        <div class="nav-bottom">
            <div class="sub-nav_content">
                <a class="sub-nav_content_a" href=""><i class="fas fa-info-circle"></i> THÔNG TIN HỖ TRỢ</a>
                <a class="sub-nav_content_a" href=""><i class="far fa-question-circle"></i> CÂU HỎI THƯỜNG GẶP</a>
            </div>
            ...
            <c:if test="${not empty userobj}">
                <div class="c-modal_item">
                    ...
                    <c:if test="${userobj.name eq 'Admin'}">
					    <a href="admin/home.jsp" class="btn-active-modal" style="margin-right: 10px;">
					        <i class="fa-solid fa-user" style="padding-right: 10px;"></i>${userobj.name}
					    </a>
					</c:if>
					
					<c:if test="${userobj.name ne 'Admin'}">
                    	<a href ="checkout.jsp" ><i class="fa-solid fa-cart-shopping fa-2x" title="Giỏ hàng" style="margin-right: 10px;"></i> </a>
					    <a href="setting.jsp" class="btn-active-modal" style="margin-right: 10px;">
					        <i class="fa-solid fa-user" style="padding-right: 10px;"></i>${userobj.name}
					    </a>
					</c:if>
                    <a data-toggle="modal" data-target="#exampleModalCenter1" class="btn-active-modal" style="margin-right: 50px;">Logout <i class="fa-solid fa-right-to-bracket"></i></a>
                </div>
            </c:if>
